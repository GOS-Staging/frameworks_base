...
import com.android.internal.genesis.hardware.LiveDisplayManager;
import android.provider.Settings;
import com.android.internal.util.genesis.ColorUtils;

import static com.android.internal.genesis.hardware.LiveDisplayManager.MODE_AUTO;
import static com.android.internal.genesis.hardware.LiveDisplayManager.MODE_DAY;
import static com.android.internal.genesis.hardware.LiveDisplayManager.MODE_NIGHT;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    public ColorTemperatureController(Context context,
        ...
        mColorBalanceCurve = com.android.internal.util.genesis.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.android.internal.util.genesis.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
